...
- Fully accessible — plain text menu, no ANSI colour codes, keyboard-only
  navigation.  Works with NVDA, JAWS, and Windows Narrator out of the box.
...
3. Follow the wizard.  After installation, launch **Wixen Uninstaller** from
   the Start menu.
4. A plain text menu will appear:

   ```
   Wixen Uninstaller — select a product to remove:

     1. McAfee Total Protection
     2. Norton 360 / Norton Security

   Enter number and press Enter (or 'q' to quit):
   ```

5. Type the number next to the product you want to remove and press **Enter**.
6. Review the report printed at the end.
